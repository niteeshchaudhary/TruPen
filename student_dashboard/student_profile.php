		...
		<div class="app-container">
			...
			<div class="app-content">
				<div class="app-sidebar">
					...
					<a href="student_profile.php" class="app-sidebar-link active">
				...
				<div class="projects-section">
					<div class="projects-section-header">
						<iframe src="../second_form_stu.php" name="targetframe" allowTransparency="true" scrolling="no" frameborder="0" style="height:750px;width:100%;border-radius:20px;" >
						</iframe>
					</div>
				</div>
			</div>
