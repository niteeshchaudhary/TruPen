...
.loadingCircle:nth-child(3) {
  ...
  if (document.location.search.match(/type=embed/gi)) {
    ...
    <form action="second_form_pro_tea.php" name="second" method="post" id="second" enctype="multipart/form-data">
    <input type="file" id="file" accept="image/*" name="image" onchange="return fileValidation()">
        ...
        ?>
					<span>
					  	<input class="balloon" id="subject" name = "subject" type="text" value="<?php echo $row["subject"]; ?>" placeholder="Your Subject" required /><label for="sub">Subject</label>
					 </span>
				<span>
